...
description: >-
  Threat-oriented hardening for APIs and miniprogram usage—treat every request
  parameter as hostile, prevent SQL injection and XSS, reduce IDOR/abuse
  risk. Use when implementing auth, queries, HTML/text rendering, file
  uploads, admin actions, or when the user mentions 安全、注入、XSS、鉴权、
  防刷、校验、黑客视角.
