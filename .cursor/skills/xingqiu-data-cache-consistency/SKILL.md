...
description: >-
  Guides MySQL 8 schema design, Redis cache usage, consistency, idempotency,
  locking, pagination, audit records, and financial ledger correctness for 星球出机.
  Use when changing database tables, indexes, migrations, Redis keys, cache
  invalidation, distributed locks, orders, payments, wallets, commissions, or
