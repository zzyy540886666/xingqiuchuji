...
description: >-
  Guides WeChat miniprogram structure, pages, WXML/WXSS/JS, wx.request to a
  self-hosted backend, modular layout, and minimalist SVG icons (no emoji in
  UI). Use when editing miniprogram sources, adding pages or components, or
  when the user mentions 小程序、微信、WXML、WXSS、wx.request、分包、组件.
