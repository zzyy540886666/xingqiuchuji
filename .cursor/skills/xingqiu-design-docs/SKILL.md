...
description: >-
  Maps 星球出机 features to design docs under docs/frontend, docs/backend,
  docs/api, and docs/architecture. Use when implementing or changing
  miniprogram pages, Spring Boot APIs, or API contracts so behavior matches
  the modular specifications.
