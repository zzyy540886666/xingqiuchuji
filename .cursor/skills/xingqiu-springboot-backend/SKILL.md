...
description: >-
  Guides Java 17 + Spring Boot 3.x backend implementation for 星球出机: REST
  controllers, DTO validation, service/domain layering, transactional boundaries,
  scheduled jobs, integrations, and springdoc OpenAPI generation. Use when
  editing backend code or when the user mentions Spring Boot、Java、Controller、
  Service、Repository、DTO、事务、定时任务、微信登录、支付回调、COS、内容安全、IM.
