...
description: "Keeps REST-style API paths, JSON fields, enums, and HTTP status semantics aligned between the WeChat miniprogram client and the self-hosted server. Use when defining or changing endpoints, DTOs, ..."
---
# 星球出机 - 前后端接口契约
