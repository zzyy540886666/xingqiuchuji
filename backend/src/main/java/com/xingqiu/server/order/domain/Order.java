...
public class Order {
    ...
    /** Total amount in cents (integer). Never use float/double for money. */
    private Long amountMinor;

    /** Deposit in cents (integer). Never use float/double for money. */
    private Long depositMinor;

    /** Shipping fee in cents (integer). Never use float/double for money. */
    private Long shippingMinor;

    /** Discount in cents (integer). Never use float/double for money. */
