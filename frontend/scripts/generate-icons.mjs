...
const p = {
  ...
  share: '<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="17" y1="11" x2="23" y2="11"/>',
  ...
  service: '<path d="M3 12a9 9 0 0 1 18 0v7"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3z"/><path d="M3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',
...
const icons = {
  ...
  share: svg(p.share, colors.primary),
  ...
  service: svg(p.service, colors.primary),
  grid: svg(p.grid),
